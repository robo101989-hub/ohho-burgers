const siteData = {
  ...
  products: [
    { name: "Crispy Chicken Burger", desc: "Crispy, juicy and loaded with OHHO flavour.", price: "₹120", veg: false, image: "images/crispy-chicken-burger.jpeg" },
    { name: "OHHO Signature Chicken Burger", desc: "Our signature chicken burger with big OHHO flavour.", price: "₹120", veg: false, image: "images/crispy-chicken-burger.jpeg" },
    { name: "OHHO Special Chicken Burger", desc: "Our loaded special chicken burger for serious cravings.", price: "₹170", veg: false, image: "images/crispy-chicken-burger.jpeg" },
    { name: "Fire Chicken Pizza", desc: "A fiery chicken pizza made for bold cravings. 🔥", price: "₹89", veg: false, image: "images/ohho-special-chicken-pizza.jpeg" },
    { name: "Veg Supreme Pizza", desc: "Loaded with flavourful veggies and melty cheese.", price: "₹99", veg: true, image: "images/ohho-special-chicken-pizza.jpeg" },
    { name: "Classic Chicken Pizza", desc: "Classic chicken, cheese and a satisfying crust.", price: "₹120", veg: false, image: "images/ohho-special-chicken-pizza.jpeg" },
    { name: "OHHO Special Chicken Pizza", desc: "Cheesy, loaded and made for serious cravings.", price: "₹150", veg: false, image: "images/ohho-special-chicken-pizza.jpeg" },
